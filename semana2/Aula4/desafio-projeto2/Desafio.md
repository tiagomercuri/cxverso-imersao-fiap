Desafio Técnico: O Catálogo Inteligente da DevAcademy
...
3. Progressividade em TypeScript
...
Utilize tags HTML5 semânticas (<article> para os cursos, <nav> para o menu, <section> para o catálogo).
